...
/*
    We need to write own wrapper for SQLite results to handle field names in results.
*/

class SQLite_Results extends PDOStatement
{
    // internal function for stripping single array keys
