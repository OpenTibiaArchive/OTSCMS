...
function NewsAJAX()
{
    ...
    this.onInsert = function()
    {
        ...
        for(i = 0; i < newList.length; i++)
        {
            ...
            if( !document.getElementById("newsID_" + ID) )
            {
                ...
                deleteLink.href = "admin.php?module=News&command=remove&id=" + ID;
                ...
                editLink.href = "admin.php?module=News&command=edit&id=" + ID;
    ...
    this.onEdit = function()
    {
        ...
        NewsFormEdit.action = "admin.php?module=News&command=update&id=" + this.lastData;
