...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <base href="http://<?php echo $_SERVER['HTTP_HOST']; ?><?php echo dirname($_SERVER['PHP_SELF']); ?>/" />
...
<?php endif; ?>
            ...
            <div><a href="home"><?php echo $language['main.menu.News.Home']; ?></a></div>
...
<?php endforeach; ?>
            ...
            <div id="pageNav">
                <div onmouseover="changeMenu('menu_Home');" id="menu_Home_Btn"><a href="home" onclick="toogleMenu('menu_Home'); return false;"><?php echo $language['main.home']; ?></a></div>
